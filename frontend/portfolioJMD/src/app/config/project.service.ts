...
export class ProjectService {
  ...
  private projects: Project[] = [
    ...
    },
    {
      ...
      description: "A university project focused on creating a platform for managing events, where users could create, sign up for, and get statistics on events. The system included a help chat, a grid for booking places, and user roles with different permissions. We used Spring Boot, JSP, and an SQL database to store the information.",
      challenges: ["Managing differentiated user roles and permissions.", "Implementing an event statistics system and a support chat.", "Adapting our work to a Scrum-style cycle with weekly meetings with the professor."],
      results: ["Regular meetings kept the development focused and improved team coordination.", "We successfully implemented all the features we set out to achieve at the start, meeting deadlines and fulfilling both our expectations and those of our professor."]
    },
    {
